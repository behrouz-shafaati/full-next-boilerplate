  ...
  getRoles(): Role[] {
    return [
      ...
      },
      {
        ...
        slug: 'auther',
        description:
          'می تواند مقاله های خود را بنویسد و آنها را ویرایش و منتشر کند. آنها همچنین می توانند مقاله های خود را حذف کنند. نقش نویسنده نمی توانند دسته بندی نوشته ها را ایجاد کنند و فقط می توانند از دسته بندی های موجود انتخاب کنند اما می توانند برچسب ها را به مقاله خود اضافه کنند. نویسندگان می توانند نظرات حتی کسانی که در انتظار بررسی و تأیید هستند را مشاهده کنند ولی نمی توانند نظری را تأیید یا حذف کنند.',
        acceptTicket: false,
      ...
      },
      {
        ...
        slug: 'contributor',
        description:
          'می توانند مقاله های جدید را اضافه کنند و فقط مقاله های خود را ویرایش کنند اما نمی توانند مقالهی را منتشر کنند حتی مقاله های خودشان را. هنگام نوشتن مقاله ها، نمی توانند دسته های جدیدی ایجاد کنند و باید از دسته های موجود انتخاب کنند با این حال آنها می توانند برچسب ها را نیز به مقاله های خود اضافه کنند.',
        acceptTicket: false,
      ...
      },
      {
        ...
        slug: 'subscriber',
        description:
          ' می توانند در سایت وارد شوند و پروفایل کاربری خود را بروزرسانی کنند. آنها می توانند رمزهای عبورشان را تغییر دهند. این نقش پنل کاربری جداگانه ای دارد و نمی تواند وارد پیشخوان مدیریتی سایت شود. این نقش حداقل نقش در میان نقش کاربران است.',
        acceptTicket: false,
        titleInTicket: '',
      },
      {
